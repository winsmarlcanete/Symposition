...
public class Waltz6 implements Screen {
    ...
    public Waltz6(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/Waltz_Part_6.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bgmusic/bg1.wav"));
        music.play();

        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/waltzpart2.wav"));
        originalMusic.play();
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
        ...
        sound1 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B5.wav"));
        Note note1 = new Note("B5",skin, sound1, false);
        ...
        sound2 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/C6.wav"));
        Note note2 = new Note("C6",skin, sound2, false);
        ...
        sound3 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/D6.wav"));
        Note note3 = new Note("D6",skin, sound3, false);
        ...
        sound5 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/G6.wav"));
        Note note5 = new Note("G6",skin,sound5, false);
        ...
        sound8 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/F6.wav"));
        Note note8 = new Note("F6",skin, sound8, false);
        ...
        sound9 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/E6.wav"));
        Note note9 = new Note("E6",skin, sound9, false);
        ...
        sound10 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/D#6.wav"));
        Note note10 = new Note("D#6",skin, sound10, false);
        ...
        note.padLeft(-38);
        for (int i = 0; i<=5 ; i++){
            note.add(notes.get(i).textbutton).width(200);
        }
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new Waltz7(game));
            music.dispose();
        }
