...
public class FurElise3 implements Screen {
    ...
    public FurElise3(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/FE/Studio3.png"));
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new FurElise4(game));
            music.dispose();
        }
