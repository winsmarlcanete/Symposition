...
public class Waltz12 implements Screen {
    ...
    public Waltz12(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/Waltz_Part_12.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bgmusic/bg1.wav"));
        music.play();

        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/waltzpart12.wav"));
        originalMusic.play();
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
        ...
        sound1 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B6.wav"));
        Note note1 = new Note("B6",skin, sound1, false);
        ...
        sound2 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/C7.wav"));
        Note note2 = new Note("C7",skin, sound2, false);
        ...
        sound3 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B6.wav"));
        Note note3 = new Note("B6",skin, sound3, false);
        ...
        sound6 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B6.wav"));
        Note note6 = new Note("B6",skin, sound6, false);
        ...
        sound7= Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/A6.wav"));
        Note note7 = new Note("A6",skin, sound7, false);
        ...
        sound8 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/A6.wav"));
        Note note8 = new Note("A6",skin, sound8, false);
        ...
        sound11 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/G#6.wav"));
        Note note11 = new Note("G#6",skin, sound11, false);
        ...
        sound12 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/E6.wav"));
        Note note12 = new Note("E6",skin, sound12, false);
        ...
        sound15 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/C7.wav"));
        Note note15 = new Note("C7",skin, sound15, false);

        note15.textbutton.addListener(new ClickListener(){
...
//        note.padLeft(-38);
    ...
    public void pass(){
        ...
        notes.get(14).setHighlighted(false);
    ...
    public void finish(){
        ...
        if (    notesOriginal.get(0).noteName == notes.get(0).noteName &&
                ...
                notesOriginal.get(14).noteName == notes.get(14).noteName
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new ScoreScreenWaltz(game));
            music.dispose();
        }
