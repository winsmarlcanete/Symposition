...
public class Waltz8 implements Screen {
    ...
    public Waltz8(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/Waltz_Part_8.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bgmusic/bg1.wav"));
        music.play();

        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/waltzpart8.wav"));
        originalMusic.play();
...
//        root.setDebug(true);
        ...
        //Re
        reSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/F#6.wav"));
        Note note2 = new Note("F#6",skin, reSound, false);
