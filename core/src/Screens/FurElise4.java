...
public class FurElise4 implements Screen {
    ...
    public FurElise4(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/FE/Studio4.png"));
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new FurElise5(game));
            music.dispose();
        }
