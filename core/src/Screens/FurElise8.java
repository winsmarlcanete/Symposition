...
public class FurElise8 implements Screen {
    ...
    public FurElise8(final Symposition game){
...
//        camera.setToOrtho(false, 800, 480);
        ...
        bg = new Texture(Gdx.files.internal("bgImages/FE/Studio8.png"));
...
//        root.setDebug(true);
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new FurElise9(game));
            music.dispose();
        }
