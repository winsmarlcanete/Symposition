...
public class Waltz11 implements Screen {
    ...
    public Waltz11(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/Waltz_Part_11.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bgmusic/bg1.wav"));
        music.play();

        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/waltzpart11.wav"));
        originalMusic.play();
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
        ...
        sound1 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/E5.wav"));
        Note note1 = new Note("E5",skin, sound1, false);
        ...
        sound2 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/G5.wav"));
        Note note2 = new Note("G5",skin, sound2, false);
        ...
        sound3 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B5.wav"));
        Note note3 = new Note("B5",skin, sound3, false);
        ...
        sound4 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/E6.wav"));
        Note note4 = new Note("E6",skin, sound4, false);
        ...
        sound5 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/G#6.wav"));
        Note note5 = new Note("G#6",skin,sound5, false);
        ...
        sound8 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/G6.wav"));
        Note note8 = new Note("G6",skin, sound8, false);
        ...
        sound10 = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/C7.wav"));
        Note note10 = new Note("C7",skin, sound10, false);
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new Waltz12(game));
            music.dispose();
        }
