...
public class Waltz4 implements Screen {
    ...
    public Waltz4(final Symposition game){
        ...
        bg = new Texture(Gdx.files.internal("bgImages/Waltz_Part_4.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bgmusic/bg1.wav"));
        music.play();

        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/waltzpart4.wav"));
        originalMusic.play();
...
//        stage = new Stage(new FillViewport(Symposition.V_WIDTH, Symposition.V_HEIGHT));
        ...
        // Do
        doSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B5.wav"));
        Note note1 = new Note("B5",skin, doSound, false);
        ...
        //Mi
        miSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/D6.wav"));
        Note note3 = new Note("D6",skin, miSound, false);
        ...
        //Fa
        faSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B6.wav"));
        Note note4 = new Note("B6",skin, faSound, false);
        ...
        //La
        laSound = Gdx.audio.newSound(Gdx.files.internal("sounds/Notes/B5.wav"));
        Note note6 = new Note("B5",skin, laSound, false);
    ...
    public void render(float delta) {
        ...
        if (nextLevel) {
            game.setScreen(new Waltz5(game));
            music.dispose();
        }
