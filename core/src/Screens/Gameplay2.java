...
public class Gameplay2 implements Screen {
    ...
    public Gameplay2(final Symposition game){
        ...
        originalMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/levelmusic/twinklepart2.wav"));
        originalMusic.play();
        ...
        Note note6 = new Note("D6",skin,skin2, laSound, false);
